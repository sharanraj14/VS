        ...
        <RevealOnScroll>
            <section className="py-16">
                <div className="text-center mb-12">
                    <h1 className="text-4xl sm:text-6xl font-extrabold text-purple-400">CRM Management</h1>
                </div>
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    <div className="lg:w-1/2">
                         <h2 className="text-3xl font-bold text-white mb-4">Streamline Your Customer Relationships</h2>
                         <p className="text-gray-300 leading-relaxed mb-4">Our comprehensive CRM (Customer Relationship Management) services are designed to help you build stronger, more profitable relationships with your customers. We handle the technical details so you can focus on what you do best: serving your clients.</p>
                         <p className="text-gray-300 leading-relaxed">From initial setup and integration to ongoing management and support, our team ensures your CRM system is a powerful asset for your business. We help you track leads, manage contacts, and analyze customer data to drive sales and improve retention.</p>
                    </div>
                    <div className="lg:w-1/2">
                        <img src="https://placehold.co/600x400/1E293B/FFFFFF?text=CRM+Dashboard" alt="CRM Dashboard" className="rounded-lg shadow-2xl"/>
                    </div>
                </div>
            </section>
        </RevealOnScroll>
