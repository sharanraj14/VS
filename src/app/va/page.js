...
const Header = () => {
    ...
    // Helper function to handle placeholder/external links
            ...
            <div className="container mx-auto flex justify-between items-center p-4">
                ...
                <div className="hidden lg:flex flex-col items-end">
                    ...
                    <div className="flex space-x-4 mt-2 text-gray-400">
                        {/* FIX: Social links are external/placeholder. Added target=_blank and rel for external security best practice. */}
